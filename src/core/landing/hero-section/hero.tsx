          ...
          <div className="flex flex-wrap">
            <div className="w-full md:px-4">
              <div className=" md:text-center">
                ...
                <p className="md:text-center mb-6 text-base leading-relaxed text-white sm:text-lg md:text-xl"> Our platform is designed for <span className="font-bold text-yellow-300">job seekers and professionals</span> looking to enhance their interview skills. </p> <p className="md:text-center mb-6 text-base leading-relaxed text-white sm:text-lg md:text-xl"> This application allows users to <span className="italic text-green-300">copy job descriptions</span> and receive tailored preparation materials. </p> <p className="md:text-center mb-6 text-base leading-relaxed text-white sm:text-lg md:text-xl"> We provide <span className="underline text-blue-300">personalized interview questions</span> to help you prepare effectively. </p> <p className="md:text-center mb-12 text-base leading-relaxed text-white sm:text-lg md:text-xl"> Additionally, our platform offers <span className="font-semibold text-pink-300">expert resume feedback</span> to improve your chances of landing that dream job. </p>
                <div className="flex gap-4 md:flex md:gap-6 items-center justify-center  sm:flex-row  sm:space-y-0  mb-6 md:mb-0">
                  <Link
                    href="/sign-up"
