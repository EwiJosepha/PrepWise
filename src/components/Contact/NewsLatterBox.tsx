...
const NewsLatterBox = () => {
  ...
  return (
    <div className="relative z-10 rounded-sm bg-primary p-8 shadow-three dark:bg-gray-dark sm:p-11 lg:p-8 xl:p-11 lg:h-[610px] h-auto">
      <h3 className="mb-4 text-2xl font-bold leading-tight text-white">
        Subscribe to receive future updates
      </h3>
      <p className="mb-11 border-b border-body-color border-opacity-25 pb-11 text-base leading-relaxed text-white dark:border-white dark:border-opacity-25">
