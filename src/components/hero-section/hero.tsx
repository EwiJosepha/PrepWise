      ...
      >
        <div className=" md:px-20">
          <div className="-mx-4 flex flex-wrap">
            <div className="w-full md:px-4 px-10">
              <div className="mx-auto max-w-[800px] text-center">
                <h1 className="mb-5 text-3xl font-bold leading-tight text-black dark:text-white sm:text-4xl sm:leading-tight md:text-5xl md:leading-tight">
                  Free Website for Interview Prep
                </h1>
                ...
                <div className="flex flex-col items-center justify-center space-y-4 sm:flex-row sm:space-x-4 sm:space-y-0">
                  ...
                  <Link
                    href="/sign-up"
                    className="inline-block rounded-sm bg-indigo-900 px-8 py-4 text-base font-semibold text-white duration-300 ease-in-out hover:bg-black/90 dark:bg-white/10 dark:text-white dark:hover:bg-white/5"
                  >
                    Get started
                  </Link>
                </div>
